...
<footer class="main-footer">
    <div class="float-right d-none d-sm-inline">
        Sistem Informasi Penjualan Made with ❤️ by <a class href="#">0xricoard</a>
    </div>
    <strong>Copyright &copy; 2021-2022 <a href="<?php echo base_url('/'); ?>">SIP Online</a>.</strong> All rights reserved.
</footer>
</div>
